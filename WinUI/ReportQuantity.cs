...
namespace WinUI
{
    public partial class ReportQuantity : Form
    {
        ...
        private void ReportQuantity_Load(object sender, EventArgs e)
        {
        ...
        private void btnList_Click(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = @"WinUI.Reports.ReportCantidad.rdlc";
        ...
        public DataTable GetSalesReportData(DateTime startDate, DateTime endDate)
        {
            ...
            using (SqlConnection conexion = new SqlConnection(cadenaConexion))
            {
                ...
                using (SqlCommand comando = new SqlCommand("masCantidad", conexion))
                {
