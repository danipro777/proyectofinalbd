...
namespace WinUI
{
    public partial class ReportAmount : Form
    {
        public ReportAmount()
        {
            InitializeComponent();
        ...
        private void ReportAmount_Load(object sender, EventArgs e)
        {
        ...
        private void btnList_Click(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = @"WinUI.Reports.ReportAmount.rdlc";
        ...
        public DataTable GetSalesReportData(DateTime startDate, DateTime endDate)
        {
            ...
            using (SqlConnection conexion = new SqlConnection(cadenaConexion))
            {
                ...
                using (SqlCommand comando = new SqlCommand("GetSales", conexion))
                {
